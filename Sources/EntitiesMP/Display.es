				...
				if(m_eVT==ECT_ENTITY){
					if(m_penTarget->PropertyForName(m_strProperty)!=NULL){
						...
						if(m_penTarget->PropertyForName(m_strProperty)->ep_eptType==CEntityProperty::EPT_BOOL){
							bValue= *((BOOL *)(((UBYTE *)(CEntity*)&*m_penTarget)+offset1)); 
							bb=TRUE;
							...
							strReplace=*((CTString *)(((UBYTE *)(CEntity*)&*m_penTarget)+offset1)); 
							bstr=TRUE;
						}
					}else if( m_bDebug){

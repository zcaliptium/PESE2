...
void PlayerGrenade(void) {
  ...
  // start moving
  LaunchAsFreeProjectile(FLOAT3D(0.0f, 0.0f, -(m_fSpeed)*m_fProjectileSpeed), (CMovableEntity*)&*m_penLauncher);
...
void PlayerBomb(void) {
  ...
  // start moving
  LaunchAsFreeProjectile(FLOAT3D(0.0f, 0.0f, fSpeed), (CMovableEntity*)&*m_penLauncher);
  SetDesiredRotation(ANGLE3D(0, FRnd()*120.0f+120.0f, FRnd()*250.0f-125.0f));
  en_fBounceDampNormal   = 0.75f;
  en_fBounceDampParallel = 0.6f;
  en_fJumpControlMultiplier = 0.0f;
...
void BotBomb(void) {
  ...
  // start moving
  //LaunchAsFreeProjectile(FLOAT3D(0.0f, 0.0f, -200.0f), (CMovableEntity*)&*m_penLauncher);
  LaunchAsPropelledProjectile(FLOAT3D(0.0f, 0.0f, -200.0f), (CMovableEntity*)&*m_penLauncher);
  //SetDesiredRotation(ANGLE3D(0, FRnd()*120.0f+120.0f, FRnd()*250.0f-125.0f));
  SetDesiredRotation(ANGLE3D(0, 0, 0));
  //en_fBounceDampNormal   = 0.75f;
  //en_fBounceDampParallel = 0.6f;
...
void HeadmanBomberman(void) {
  ...
  // start moving
  LaunchAsFreeProjectile(FLOAT3D(0.0f, 0.0f, -m_fSpeed*1.5f), (CMovableEntity*)&*m_penLauncher);

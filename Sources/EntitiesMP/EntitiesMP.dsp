...
# ADD CPP /nologo /G5 /MD /W3 /GX /Zi /Ox /Ot /Og /Oi /Oy- /I "$(SOURCE_DIR)" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_WINDLL" /D "_AFXDLL" /D "_MBCS" /D "_USRDLL" /Yu"StdH.h" /FD /c
...
# ADD LINK32 /nologo /subsystem:windows /dll /map /debug /machine:I386 /pdbtype:sept /libpath:"$(SOURCE_DIR)"
...
BuildCmds= \
	...
	copy Release\$(InputName).dll $(ENGINE_DIR3) >nul \
	

"$(ENGINE_DIR)\Bin\$(InputName).dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"$(ENGINE_DIR3)\$(InputName).dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
...
SOURCE=.\PESpawnBattery.cpp
# End Source File
# Begin Source File

SOURCE=.\PESpawner.cpp
# End Source File
# Begin Source File

SOURCE=.\PESpawnerEG.cpp
# End Source File
# Begin Source File

SOURCE=.\PESpawnProjectile.cpp
# End Source File
# Begin Source File

SOURCE=.\PESpawnProjectile2.cpp
# End Source File
# Begin Source File
...
SOURCE=.\PlayerBot.cpp
# End Source File
# Begin Source File

SOURCE=.\PlayerBotView.cpp
...
SOURCE=.\TemplateCreator.cpp
# End Source File
# Begin Source File

SOURCE=.\TemplateCreatorEG.cpp
# End Source File
# Begin Source File
...
SOURCE=.\BatteryMarker.h
# End Source File
# Begin Source File

SOURCE=.\BatteryMarker_tables.h
# End Source File
# Begin Source File
...
SOURCE=.\FireworksDisplay.h
# End Source File
# Begin Source File

SOURCE=.\FireworksDisplay_tables.h
# End Source File
# Begin Source File
...
SOURCE=.\LightningRay.h
# End Source File
# Begin Source File

SOURCE=.\LightningRay_tables.h
# End Source File
# Begin Source File
...
SOURCE=.\PESpawnBattery.h
# End Source File
# Begin Source File

SOURCE=.\PESpawnBattery_tables.h
# End Source File
# Begin Source File
...
SOURCE=.\PESpawner_tables.h
# End Source File
# Begin Source File

SOURCE=.\PESpawnerEG.h
# End Source File
# Begin Source File

SOURCE=.\PESpawnerEG_tables.h
# End Source File
# Begin Source File

SOURCE=.\PESpawnProjectile.h
# End Source File
# Begin Source File

SOURCE=.\PESpawnProjectile2.h
# End Source File
# Begin Source File

SOURCE=.\PESpawnProjectile2_tables.h
# End Source File
# Begin Source File

SOURCE=.\PESpawnProjectile_tables.h
# End Source File
# Begin Source File
...
SOURCE=.\PlayerBot_tables.h
# End Source File
# Begin Source File

SOURCE=.\PlayerBotView.h
...
SOURCE=.\TemplateCreator.h
# End Source File
# Begin Source File

SOURCE=.\TemplateCreator_tables.h
# End Source File
# Begin Source File

SOURCE=.\TemplateCreatorEG.h
# End Source File
# Begin Source File

SOURCE=.\TemplateCreatorEG_tables.h
# End Source File
# Begin Source File
...
SOURCE=.\Tracer_tables.h
# End Source File
# Begin Source File

SOURCE=.\TransProjectile.h
# End Source File
# Begin Source File

SOURCE=.\TransProjectile_tables.h
# End Source File
# Begin Source File
...
SOURCE=.\FireworksDisplay.es

!IF  "$(CFG)" == "EntitiesMP - Win32 Release"

# Begin Custom Build - EntitiesMP/$(InputName).es
InputPath=.\FireworksDisplay.es
InputName=FireworksDisplay
...
SOURCE=.\PESpawnBattery.es

!IF  "$(CFG)" == "EntitiesMP - Win32 Release"

# Begin Custom Build - EntitiesMP/$(InputName).es
InputPath=.\PESpawnBattery.es
InputName=PESpawnBattery
...
SOURCE=.\PESpawnerEG.es

!IF  "$(CFG)" == "EntitiesMP - Win32 Release"

# Begin Custom Build - EntitiesMP/$(InputName).es
InputPath=.\PESpawnerEG.es
InputName=PESpawnerEG
...
SOURCE=.\PESpawnProjectile.es

!IF  "$(CFG)" == "EntitiesMP - Win32 Release"

# Begin Custom Build - EntitiesMP/$(InputName).es
InputPath=.\PESpawnProjectile.es
InputName=PESpawnProjectile
...
SOURCE=.\PESpawnProjectile2.es

!IF  "$(CFG)" == "EntitiesMP - Win32 Release"

# Begin Custom Build - EntitiesMP/$(InputName).es
InputPath=.\PESpawnProjectile2.es
InputName=PESpawnProjectile2
...
SOURCE=.\TemplateCreator.es

!IF  "$(CFG)" == "EntitiesMP - Win32 Release"

# Begin Custom Build - EntitiesMP/$(InputName).es
InputPath=.\TemplateCreator.es
InputName=TemplateCreator
...
SOURCE=.\TemplateCreatorEG.es

!IF  "$(CFG)" == "EntitiesMP - Win32 Release"

# Begin Custom Build - EntitiesMP/$(InputName).es
InputPath=.\TemplateCreatorEG.es
InputName=TemplateCreatorEG
...
SOURCE=.\BatteryMarker.es

!IF  "$(CFG)" == "EntitiesMP - Win32 Release"

# Begin Custom Build - EntitiesMP/$(InputName).es
InputPath=.\BatteryMarker.es
InputName=BatteryMarker
...
SOURCE=.\LightningRay.es

!IF  "$(CFG)" == "EntitiesMP - Win32 Release"

# Begin Custom Build - EntitiesMP/$(InputName).es
InputPath=.\LightningRay.es
InputName=LightningRay
...
SOURCE=.\TransProjectile.es

!IF  "$(CFG)" == "EntitiesMP - Win32 Release"

# Begin Custom Build - EntitiesMP/$(InputName).es
InputPath=.\TransProjectile.es
InputName=TransProjectile
